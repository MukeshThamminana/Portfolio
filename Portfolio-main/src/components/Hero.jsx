  ...
  return (
    ...
    >
      ...
      <div className="z-20 max-w-5xl space-y-5">
        ...
        >
          Hey, I'm <span className="text-purple-400">MUKESH THAMMINANA</span>
        </motion.h1>
        ...
        >
         I am a skilled professional with expertise in DATA SCIENCE and MERN STACK developer. I specialize in leveraging data to uncover insights and drive decisions, with a strong foundation in machine learning, statistical analysis, and data visualization. On the development side, I work with the MERN stack (MongoDB, Express.js, React, Node.js) to build dynamic, high-performance web applications. With a passion for both data-driven solutions and full-stack development, I aim to bridge the gap between technical challenges and innovative solutions.
        </motion.p>
